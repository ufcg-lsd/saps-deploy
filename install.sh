...
readonly HOSTS_PRIVATE_KEY_FILE_PATH_PATTERN="hosts_ssh_private_key_file"
...
readonly CATALOG_HOST_PRIVATE_KEY_FILE_PATH=$(get_value ${HOSTS_CONF_FILE_PATH} ${HOSTS_PRIVATE_KEY_FILE_PATH_PATTERN})
readonly DISPATCHER_HOST_IP=$(get_value ${HOSTS_CONF_FILE_PATH} ${DISPATCHER_HOST_IP_PATTERN})
readonly DISPATCHER_HOST_PRIVATE_KEY_FILE_PATH=$(get_value ${HOSTS_CONF_FILE_PATH} ${HOSTS_PRIVATE_KEY_FILE_PATH_PATTERN})
readonly SCHEDULER_HOST_IP=$(get_value ${HOSTS_CONF_FILE_PATH} ${SCHEDULER_HOST_IP_PATTERN})
readonly SCHEDULER_HOST_PRIVATE_KEY_FILE_PATH=$(get_value ${HOSTS_CONF_FILE_PATH} ${HOSTS_PRIVATE_KEY_FILE_PATH_PATTERN})
readonly ARCHIVER_HOST_IP=$(get_value ${HOSTS_CONF_FILE_PATH} ${ARCHIVER_HOST_IP_PATTERN})
readonly ARCHIVER_HOST_PRIVATE_KEY_FILE_PATH=$(get_value ${HOSTS_CONF_FILE_PATH} ${HOSTS_PRIVATE_KEY_FILE_PATH_PATTERN})
readonly TEMP_STORAGE_HOST_IP=$(get_value ${HOSTS_CONF_FILE_PATH} ${TEMP_STORAGE_HOST_IP_PATTERN})
readonly TEMP_STORAGE_HOST_PRIVATE_KEY_FILE_PATH=$(get_value ${HOSTS_CONF_FILE_PATH} ${HOSTS_PRIVATE_KEY_FILE_PATH_PATTERN})
